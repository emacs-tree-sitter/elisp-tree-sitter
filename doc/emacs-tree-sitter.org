...
The author of Tree-sitter articulated its merits a lot better in this [[https://www.thestrangeloop.com/2018/tree-sitter---a-new-parsing-system-for-programming-tools.html][Strange Loop talk]].
...
The package [[https://github.com/emacs-tree-sitter/tree-sitter-langs][tree-sitter-langs]] is a language bundle that contains shared libraries for some languages (as well as syntax highlighting queries). When it is loaded, its shared libraries are prioritized over the CLI's directory.
