...
{{% notice warning %}}
Binaries for older versions were hosted on bintray, which was [[https://www.infoq.com/news/2021/02/jfrog-jcenter-bintray-closure/][shut down]]. If you install from source, you should update the code to a newer version whose binaries are hosted [[https://github.com/ubolonton/emacs-tree-sitter/releases][on GitHub]].
